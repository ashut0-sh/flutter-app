...
class _DeliveredOrdersState extends State<DeliveredOrders> {
  ...
  Future<List> getPosts() async {
    String baseURL = "https://final-server-opjhx9ifm-ravipcb.vercel.app/deliveredorder";
    try {
  ...
  void updateState(String id,String status){
      ...
      builder: (context) => AlertDialog(
            ...
            actions: [
              TextButton(
                child: Text("submit"),
                onPressed: () {
                  updateState(id,statusUpdateController.text);
